...
main:
    ...
    STA $1 ; @REG A=0x01 X=0x02 Y=0x03 S=0xfd P=0b00100100 PC=0x8008 @RAM Addr=0x0001 Value=0x01
    STX $2 ; @REG A=0x01 X=0x02 Y=0x03 S=0xfd P=0b00100100 PC=0x800a @RAM Addr=0x0002 Value=0x02
    STY $3 ; @REG A=0x01 X=0x02 Y=0x03 S=0xfd P=0b00100100 PC=0x800c @RAM Addr=0x0003 Value=0x03
