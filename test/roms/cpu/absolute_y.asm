...
main:
    ...
    CMP $07ff,Y ; 0x800d @REG A=0x5a X=0x5a Y=0x01 S=0xfd P=0b00100111 PC=0x8010

    SBC $07ff,Y ; 0x8010 @REG A=0x00 X=0x5a Y=0x01 S=0xfd P=0b00100111 PC=0x8013
    ADC $07ff,Y ; 0x8013 @REG A=0x5b X=0x5a Y=0x01 S=0xfd P=0b00100100 PC=0x8016

    EOR $07ff,Y ; 0x8016 @REG A=0x01 X=0x5a Y=0x01 S=0xfd P=0b00100100 PC=0x8019
