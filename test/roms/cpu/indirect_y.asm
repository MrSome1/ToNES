...
main:
    ...
    CMP ($fe),Y ; 0x8011 @REG A=0x0f X=0x0a Y=0x02 S=0xfd P=0b00100100 PC=0x8013

    SBC ($fe),Y ; 0x8013 @REG A=0x05 X=0x0a Y=0x02 S=0xfd P=0b00100100 PC=0x8015

    STA ($fe),Y ; 0x8015 @REG A=0x05 X=0x0a Y=0x02 S=0xfd P=0b00100100 PC=0x8017 @RAM 0x0705 0x05

    ADC ($fe),Y ; 0x8017 @REG A=0x0a X=0x0a Y=0x02 S=0xfd P=0b00100100 PC=0x8019

    AND ($fe),Y ; 0x8019 @REG A=0x00 X=0x0a Y=0x02 S=0xfd P=0b00100110 PC=0x801b
